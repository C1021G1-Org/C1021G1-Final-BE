...
public class FlightServiceImpl implements IFlightService {
    ...
    @Override
    public Map<String, Page<FlightSearchDto>> searchAvailableFlight(String departureDestination, String arrivalDestination, String departureDate, String arrivalDate, String sortOption, Pageable pageable) {
